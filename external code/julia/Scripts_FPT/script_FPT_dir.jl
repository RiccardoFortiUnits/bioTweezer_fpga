...
A = parse(Float64, ARGS[3])# parse(Float64, readline())
# print("Please enter the value of the initial position x_0 ")
x_0 = parse(Float64, ARGS[4])#parse(Float64, readline())
