...
set variant_name tse_core
set dut_device_family "CYCLONEV"
...
lappend dut_parameters "--component-param=enable_shift16=false"
...
lappend dut_parameters "--component-param=enable_magic_detect=false"
lappend dut_parameters "--component-param=useMDIO=false"
...
if { [string match "QSYS_PRO" $is_qsys_edition] } {
	...
	puts $temp
    catch {eval [concat [list exec "qsys-generate" --simulation=VERILOG] "${output_dir}/${variant_name}.ip"]} temp
	puts $temp
} else { 
