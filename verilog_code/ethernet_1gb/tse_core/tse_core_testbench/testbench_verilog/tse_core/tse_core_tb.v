...
parameter ENABLE_CLK_SHARING = 1;
...
parameter DEVICE_FAMILY = "CYCLONEV";
...
//DUT interconnects
wire rx_afull_clk;
wire [RX_AFULL_CHANNEL_WIDTH - 1:0]  rx_afull_channel;
...
wire  led_panel_link_0;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_1;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_2;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_3;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_4;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_5;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_6;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_7;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_8;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_9;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_10;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_11;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_12;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_13;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_14;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_15;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_16;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_17;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_18;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_19;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_20;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_21;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_22;         //  Valid Copper and Fiber Link 
...
wire  led_panel_link_23;         //  Valid Copper and Fiber Link 
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_0;
...
wire    [95:0]  tx_egress_timestamp_96b_data_0;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_0;
wire            tx_egress_timestamp_96b_valid_0;
wire    [63:0]  tx_egress_timestamp_64b_data_0;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_0;
wire            tx_egress_timestamp_64b_valid_0;
wire            rx_ingress_timestamp_96b_valid_0;
wire    [95:0]  rx_ingress_timestamp_96b_data_0;
wire    [63:0]  rx_ingress_timestamp_64b_data_0;
wire            rx_ingress_timestamp_64b_valid_0;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_1;
...
wire    [95:0]  tx_egress_timestamp_96b_data_1;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_1;
wire            tx_egress_timestamp_96b_valid_1;
wire    [63:0]  tx_egress_timestamp_64b_data_1;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_1;
wire            tx_egress_timestamp_64b_valid_1;
wire            rx_ingress_timestamp_96b_valid_1;
wire    [95:0]  rx_ingress_timestamp_96b_data_1;
wire    [63:0]  rx_ingress_timestamp_64b_data_1;
wire            rx_ingress_timestamp_64b_valid_1;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_2;
...
wire    [95:0]  tx_egress_timestamp_96b_data_2;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_2;
wire            tx_egress_timestamp_96b_valid_2;
wire    [63:0]  tx_egress_timestamp_64b_data_2;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_2;
wire            tx_egress_timestamp_64b_valid_2;
wire            rx_ingress_timestamp_96b_valid_2;
wire    [95:0]  rx_ingress_timestamp_96b_data_2;
wire    [63:0]  rx_ingress_timestamp_64b_data_2;
wire            rx_ingress_timestamp_64b_valid_2;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_3;
...
wire    [95:0]  tx_egress_timestamp_96b_data_3;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_3;
wire            tx_egress_timestamp_96b_valid_3;
wire    [63:0]  tx_egress_timestamp_64b_data_3;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_3;
wire            tx_egress_timestamp_64b_valid_3;
wire            rx_ingress_timestamp_96b_valid_3;
wire    [95:0]  rx_ingress_timestamp_96b_data_3;
wire    [63:0]  rx_ingress_timestamp_64b_data_3;
wire            rx_ingress_timestamp_64b_valid_3;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_4;
...
wire    [95:0]  tx_egress_timestamp_96b_data_4;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_4;
wire            tx_egress_timestamp_96b_valid_4;
wire    [63:0]  tx_egress_timestamp_64b_data_4;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_4;
wire            tx_egress_timestamp_64b_valid_4;
wire            rx_ingress_timestamp_96b_valid_4;
wire    [95:0]  rx_ingress_timestamp_96b_data_4;
wire    [63:0]  rx_ingress_timestamp_64b_data_4;
wire            rx_ingress_timestamp_64b_valid_4;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_5;
...
wire    [95:0]  tx_egress_timestamp_96b_data_5;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_5;
wire            tx_egress_timestamp_96b_valid_5;
wire    [63:0]  tx_egress_timestamp_64b_data_5;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_5;
wire            tx_egress_timestamp_64b_valid_5;
wire            rx_ingress_timestamp_96b_valid_5;
wire    [95:0]  rx_ingress_timestamp_96b_data_5;
wire    [63:0]  rx_ingress_timestamp_64b_data_5;
wire            rx_ingress_timestamp_64b_valid_5;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_6;
...
wire    [95:0]  tx_egress_timestamp_96b_data_6;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_6;
wire            tx_egress_timestamp_96b_valid_6;
wire    [63:0]  tx_egress_timestamp_64b_data_6;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_6;
wire            tx_egress_timestamp_64b_valid_6;
wire            rx_ingress_timestamp_96b_valid_6;
wire    [95:0]  rx_ingress_timestamp_96b_data_6;
wire    [63:0]  rx_ingress_timestamp_64b_data_6;
wire            rx_ingress_timestamp_64b_valid_6;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_7;
...
wire    [95:0]  tx_egress_timestamp_96b_data_7;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_7;
wire            tx_egress_timestamp_96b_valid_7;
wire    [63:0]  tx_egress_timestamp_64b_data_7;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_7;
wire            tx_egress_timestamp_64b_valid_7;
wire            rx_ingress_timestamp_96b_valid_7;
wire    [95:0]  rx_ingress_timestamp_96b_data_7;
wire    [63:0]  rx_ingress_timestamp_64b_data_7;
wire            rx_ingress_timestamp_64b_valid_7;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_8;
...
wire    [95:0]  tx_egress_timestamp_96b_data_8;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_8;
wire            tx_egress_timestamp_96b_valid_8;
wire    [63:0]  tx_egress_timestamp_64b_data_8;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_8;
wire            tx_egress_timestamp_64b_valid_8;
wire            rx_ingress_timestamp_96b_valid_8;
wire    [95:0]  rx_ingress_timestamp_96b_data_8;
wire    [63:0]  rx_ingress_timestamp_64b_data_8;
wire            rx_ingress_timestamp_64b_valid_8;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_9;
...
wire    [95:0]  tx_egress_timestamp_96b_data_9;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_9;
wire            tx_egress_timestamp_96b_valid_9;
wire    [63:0]  tx_egress_timestamp_64b_data_9;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_9;
wire            tx_egress_timestamp_64b_valid_9;
wire            rx_ingress_timestamp_96b_valid_9;
wire    [95:0]  rx_ingress_timestamp_96b_data_9;
wire    [63:0]  rx_ingress_timestamp_64b_data_9;
wire            rx_ingress_timestamp_64b_valid_9;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_10;
...
wire    [95:0]  tx_egress_timestamp_96b_data_10;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_10;
wire            tx_egress_timestamp_96b_valid_10;
wire    [63:0]  tx_egress_timestamp_64b_data_10;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_10;
wire            tx_egress_timestamp_64b_valid_10;
wire            rx_ingress_timestamp_96b_valid_10;
wire    [95:0]  rx_ingress_timestamp_96b_data_10;
wire    [63:0]  rx_ingress_timestamp_64b_data_10;
wire            rx_ingress_timestamp_64b_valid_10;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_11;
...
wire    [95:0]  tx_egress_timestamp_96b_data_11;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_11;
wire            tx_egress_timestamp_96b_valid_11;
wire    [63:0]  tx_egress_timestamp_64b_data_11;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_11;
wire            tx_egress_timestamp_64b_valid_11;
wire            rx_ingress_timestamp_96b_valid_11;
wire    [95:0]  rx_ingress_timestamp_96b_data_11;
wire    [63:0]  rx_ingress_timestamp_64b_data_11;
wire            rx_ingress_timestamp_64b_valid_11;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_12;
...
wire    [95:0]  tx_egress_timestamp_96b_data_12;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_12;
wire            tx_egress_timestamp_96b_valid_12;
wire    [63:0]  tx_egress_timestamp_64b_data_12;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_12;
wire            tx_egress_timestamp_64b_valid_12;
wire            rx_ingress_timestamp_96b_valid_12;
wire    [95:0]  rx_ingress_timestamp_96b_data_12;
wire    [63:0]  rx_ingress_timestamp_64b_data_12;
wire            rx_ingress_timestamp_64b_valid_12;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_13;
...
wire    [95:0]  tx_egress_timestamp_96b_data_13;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_13;
wire            tx_egress_timestamp_96b_valid_13;
wire    [63:0]  tx_egress_timestamp_64b_data_13;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_13;
wire            tx_egress_timestamp_64b_valid_13;
wire            rx_ingress_timestamp_96b_valid_13;
wire    [95:0]  rx_ingress_timestamp_96b_data_13;
wire    [63:0]  rx_ingress_timestamp_64b_data_13;
wire            rx_ingress_timestamp_64b_valid_13;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_14;
...
wire    [95:0]  tx_egress_timestamp_96b_data_14;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_14;
wire            tx_egress_timestamp_96b_valid_14;
wire    [63:0]  tx_egress_timestamp_64b_data_14;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_14;
wire            tx_egress_timestamp_64b_valid_14;
wire            rx_ingress_timestamp_96b_valid_14;
wire    [95:0]  rx_ingress_timestamp_96b_data_14;
wire    [63:0]  rx_ingress_timestamp_64b_data_14;
wire            rx_ingress_timestamp_64b_valid_14;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_15;
...
wire    [95:0]  tx_egress_timestamp_96b_data_15;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_15;
wire            tx_egress_timestamp_96b_valid_15;
wire    [63:0]  tx_egress_timestamp_64b_data_15;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_15;
wire            tx_egress_timestamp_64b_valid_15;
wire            rx_ingress_timestamp_96b_valid_15;
wire    [95:0]  rx_ingress_timestamp_96b_data_15;
wire    [63:0]  rx_ingress_timestamp_64b_data_15;
wire            rx_ingress_timestamp_64b_valid_15;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_16;
...
wire    [95:0]  tx_egress_timestamp_96b_data_16;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_16;
wire            tx_egress_timestamp_96b_valid_16;
wire    [63:0]  tx_egress_timestamp_64b_data_16;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_16;
wire            tx_egress_timestamp_64b_valid_16;
wire            rx_ingress_timestamp_96b_valid_16;
wire    [95:0]  rx_ingress_timestamp_96b_data_16;
wire    [63:0]  rx_ingress_timestamp_64b_data_16;
wire            rx_ingress_timestamp_64b_valid_16;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_17;
...
wire    [95:0]  tx_egress_timestamp_96b_data_17;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_17;
wire            tx_egress_timestamp_96b_valid_17;
wire    [63:0]  tx_egress_timestamp_64b_data_17;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_17;
wire            tx_egress_timestamp_64b_valid_17;
wire            rx_ingress_timestamp_96b_valid_17;
wire    [95:0]  rx_ingress_timestamp_96b_data_17;
wire    [63:0]  rx_ingress_timestamp_64b_data_17;
wire            rx_ingress_timestamp_64b_valid_17;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_18;
...
wire    [95:0]  tx_egress_timestamp_96b_data_18;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_18;
wire            tx_egress_timestamp_96b_valid_18;
wire    [63:0]  tx_egress_timestamp_64b_data_18;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_18;
wire            tx_egress_timestamp_64b_valid_18;
wire            rx_ingress_timestamp_96b_valid_18;
wire    [95:0]  rx_ingress_timestamp_96b_data_18;
wire    [63:0]  rx_ingress_timestamp_64b_data_18;
wire            rx_ingress_timestamp_64b_valid_18;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_19;
...
wire    [95:0]  tx_egress_timestamp_96b_data_19;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_19;
wire            tx_egress_timestamp_96b_valid_19;
wire    [63:0]  tx_egress_timestamp_64b_data_19;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_19;
wire            tx_egress_timestamp_64b_valid_19;
wire            rx_ingress_timestamp_96b_valid_19;
wire    [95:0]  rx_ingress_timestamp_96b_data_19;
wire    [63:0]  rx_ingress_timestamp_64b_data_19;
wire            rx_ingress_timestamp_64b_valid_19;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_20;
...
wire    [95:0]  tx_egress_timestamp_96b_data_20;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_20;
wire            tx_egress_timestamp_96b_valid_20;
wire    [63:0]  tx_egress_timestamp_64b_data_20;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_20;
wire            tx_egress_timestamp_64b_valid_20;
wire            rx_ingress_timestamp_96b_valid_20;
wire    [95:0]  rx_ingress_timestamp_96b_data_20;
wire    [63:0]  rx_ingress_timestamp_64b_data_20;
wire            rx_ingress_timestamp_64b_valid_20;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_21;
...
wire    [95:0]  tx_egress_timestamp_96b_data_21;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_21;
wire            tx_egress_timestamp_96b_valid_21;
wire    [63:0]  tx_egress_timestamp_64b_data_21;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_21;
wire            tx_egress_timestamp_64b_valid_21;
wire            rx_ingress_timestamp_96b_valid_21;
wire    [95:0]  rx_ingress_timestamp_96b_data_21;
wire    [63:0]  rx_ingress_timestamp_64b_data_21;
wire            rx_ingress_timestamp_64b_valid_21;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_22;
...
wire    [95:0]  tx_egress_timestamp_96b_data_22;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_22;
wire            tx_egress_timestamp_96b_valid_22;
wire    [63:0]  tx_egress_timestamp_64b_data_22;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_22;
wire            tx_egress_timestamp_64b_valid_22;
wire            rx_ingress_timestamp_96b_valid_22;
wire    [95:0]  rx_ingress_timestamp_96b_data_22;
wire    [63:0]  rx_ingress_timestamp_64b_data_22;
wire            rx_ingress_timestamp_64b_valid_22;
...
wire	[TSTAMP_FP_WIDTH-1:0]	tx_egress_timestamp_request_fingerprint_23;
...
wire    [95:0]  tx_egress_timestamp_96b_data_23;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_96b_fingerprint_23;
wire            tx_egress_timestamp_96b_valid_23;
wire    [63:0]  tx_egress_timestamp_64b_data_23;
wire    [TSTAMP_FP_WIDTH-1:0] tx_egress_timestamp_64b_fingerprint_23;
wire            tx_egress_timestamp_64b_valid_23;
wire            rx_ingress_timestamp_96b_valid_23;
wire    [95:0]  rx_ingress_timestamp_96b_data_23;
wire    [63:0]  rx_ingress_timestamp_64b_data_23;
wire            rx_ingress_timestamp_64b_valid_23;
...
reg     [REG_ADDR_WIDTH - 1:0] reg_addr;                 //  Register Address
...
assign tx_egress_timestamp_request_fingerprint_0 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_0 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_0 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_0 = 1'b0;
assign tx_egress_timestamp_64b_data_0 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_0 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_0 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_1 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_1 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_1 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_1 = 1'b0;
assign tx_egress_timestamp_64b_data_1 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_1 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_1 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_2 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_2 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_2 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_2 = 1'b0;
assign tx_egress_timestamp_64b_data_2 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_2 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_2 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_3 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_3 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_3 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_3 = 1'b0;
assign tx_egress_timestamp_64b_data_3 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_3 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_3 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_4 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_4 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_4 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_4 = 1'b0;
assign tx_egress_timestamp_64b_data_4 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_4 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_4 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_5 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_5 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_5 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_5 = 1'b0;
assign tx_egress_timestamp_64b_data_5 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_5 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_5 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_6 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_6 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_6 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_6 = 1'b0;
assign tx_egress_timestamp_64b_data_6 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_6 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_6 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_7 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_7 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_7 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_7 = 1'b0;
assign tx_egress_timestamp_64b_data_7 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_7 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_7 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_8 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_8 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_8 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_8 = 1'b0;
assign tx_egress_timestamp_64b_data_8 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_8 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_8 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_9 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_9 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_9 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_9 = 1'b0;
assign tx_egress_timestamp_64b_data_9 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_9 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_9 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_10 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_10 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_10 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_10 = 1'b0;
assign tx_egress_timestamp_64b_data_10 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_10 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_10 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_11 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_11 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_11 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_11 = 1'b0;
assign tx_egress_timestamp_64b_data_11 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_11 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_11 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_12 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_12 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_12 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_12 = 1'b0;
assign tx_egress_timestamp_64b_data_12 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_12 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_12 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_13 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_13 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_13 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_13 = 1'b0;
assign tx_egress_timestamp_64b_data_13 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_13 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_13 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_14 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_14 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_14 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_14 = 1'b0;
assign tx_egress_timestamp_64b_data_14 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_14 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_14 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_15 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_15 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_15 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_15 = 1'b0;
assign tx_egress_timestamp_64b_data_15 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_15 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_15 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_16 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_16 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_16 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_16 = 1'b0;
assign tx_egress_timestamp_64b_data_16 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_16 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_16 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_17 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_17 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_17 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_17 = 1'b0;
assign tx_egress_timestamp_64b_data_17 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_17 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_17 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_18 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_18 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_18 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_18 = 1'b0;
assign tx_egress_timestamp_64b_data_18 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_18 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_18 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_19 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_19 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_19 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_19 = 1'b0;
assign tx_egress_timestamp_64b_data_19 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_19 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_19 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_20 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_20 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_20 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_20 = 1'b0;
assign tx_egress_timestamp_64b_data_20 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_20 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_20 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_21 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_21 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_21 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_21 = 1'b0;
assign tx_egress_timestamp_64b_data_21 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_21 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_21 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_22 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_22 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_22 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_22 = 1'b0;
assign tx_egress_timestamp_64b_data_22 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_22 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_22 = 1'b0;
...
assign tx_egress_timestamp_request_fingerprint_23 = {TSTAMP_FP_WIDTH{1'b0}};
...
assign tx_egress_timestamp_96b_data_23 = 96'h0;
assign tx_egress_timestamp_96b_fingerprint_23 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_96b_valid_23 = 1'b0;
assign tx_egress_timestamp_64b_data_23 = 64'h0;
assign tx_egress_timestamp_64b_fingerprint_23 = {TSTAMP_FP_WIDTH{1'b0}};
assign tx_egress_timestamp_64b_valid_23 = 1'b0;
...
generate
  ...
  if (MAX_CHANNELS == 1)
   begin
    ...
    assign led_panel_link = led_panel_link_0 ;
    //input of DUT
...
assign #(2) mdio = (mdio_oen==1'b1)?1'bZ:mdio_out;
...
//  ---------
      ...
      else if (nextstate == stm_typ_wait_reg_clear)
         begin
         reg_wr <= #(2)1'b 0;   
         reg_rd <= #(2) 1'b 1;  
         reg_addr <= #(2) 2 ;        // fix for HSD 1507062627    
         reg_data_in <= #(2)  32'h 00000000;            
         end
