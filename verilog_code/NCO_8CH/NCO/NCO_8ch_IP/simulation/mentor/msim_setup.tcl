...
# ----------------------------------------
# If NCO_8ch_IP is one of several IP cores in your
...
# ----------------------------------------
# ACDS 22.1 922 win32 2024.05.09.11:56:55
...
alias file_copy {
  echo "\[exec\] file_copy"
  file copy -force $QSYS_SIMDIR/submodules/NCO_8ch_IP_nco_ii_0_sin.hex ./
  file copy -force $QSYS_SIMDIR/submodules/NCO_8ch_IP_nco_ii_0_cos.hex ./
}
...
alias com {
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/mentor/asj_altqmcash.v"    -work nco_ii_0
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/NCO_8ch_IP_nco_ii_0.v"     -work nco_ii_0
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/NCO_8ch_IP.v"                                       
}
...
alias elab_debug {
  ...
  eval vsim -voptargs=+acc -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L nco_ii_0 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
