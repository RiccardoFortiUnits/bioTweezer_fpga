...
set_multicycle_path -setup -start 1 -from [get_clocks ADC_outclock_50] -to [get_clocks sclk_DAC_port]
set_multicycle_path -hold -start 1 -from [get_clocks ADC_outclock_50] -to [get_clocks sclk_DAC_port]
...
set_clock_groups -asynchronous \
                ...
                -group { \
                        ...
                        sclk_DAC \
								ADC_outclock_50 \
                        ADC_FAST_wrapper:ADC_FAST_wrapper_0|adc_lvds:adc_lvds_0|altlvds_rx:ALTLVDS_RX_component|adc_lvds_lvds_rx1:auto_generated|wire_pll_sclk_outclk \
                        } \
                -group { \
                        REFCLK_125 \
